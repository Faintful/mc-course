...
import net.faintful.mccourse.item.inventory.ImplementedInventory;
import net.faintful.mccourse.recipe.OrichalcumBlasterRecipe;
import net.faintful.mccourse.screen.OrichalcumBlasterScreenHandler;
