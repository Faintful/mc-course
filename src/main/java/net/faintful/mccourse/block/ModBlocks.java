package net.faintful.mccourse.block;
...
import net.faintful.mccourse.world.feature.tree.CherryBlossomSaplingGenerator;
...
public class ModBlocks {
    ...
    public static final Block CHERRY_BLOSSOM_WALL_SIGN_BLOCK = registerBlockWithoutBlockItem("cherry_blossom_wall_sign", new WallSignBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS), ModSignTypes.CHERRY_BLOSSOM));
    ...
    private static Block registerBlockWithoutBlock(String name, Block block) {
        return Registry.register(Registry.BLOCK, new Identifier(MCCourseMod.MOD_ID, name), block);
    }

    private static Item registerBlockItem(String name, Block block, ItemGroup group){
        return Registry.register(Registry.ITEM, new Identifier(MCCourseMod.MOD_ID, name), new BlockItem(block, new FabricItemSettings().group(group)));
    }
