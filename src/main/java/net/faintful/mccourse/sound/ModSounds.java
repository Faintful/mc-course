package net.faintful.mccourse.sound;
...
public class ModSounds {
    ...
    public static final BlockSoundGroup ORICHALCUM_SOUNDS = new BlockSoundGroup(1f, 1f, ModSounds.ORICHALCUM_LAMP_BREAK, ModSounds.ORICHALCUM_LAMP_STEP, ModSounds.ORICHALCUM_LAMP_PLACE, ModSounds.ORICHALCUM_LAMP_HIT, ModSounds.ORICHALCUM_LAMP_FALL);
